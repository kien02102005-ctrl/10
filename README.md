...
<body>
  ...
  apiKey: "AIzaSyAdqpRkeqLIB9T4S8UIPpx2xi4YwnjfnH8",
  authDomain: "linhnguyenxuan.firebaseapp.com",
  projectId: "linhnguyenxuan",
  storageBucket: "linhnguyenxuan.firebasestorage.app",
  messagingSenderId: "105256163069",
  appId: "1:105256163069:web:5eb2a75fded0bd00f95094",
  measurementId: "G-YFF8EEFX9C"
};

        firebase.initializeApp(firebaseConfig);
        const db = firebase.database();

        const ADMIN_USERNAME = 'Nguyễn Thị Thúy Hà';
        ...
        function uploadScheduleFile(inputEl) {
            if (!isAdmin) {
                alert("Chỉ có tài khoản Admin (Nguyễn Thị Thúy Hà) mới có quyền đăng tệp Lịch công tác!");
                return;
            }
